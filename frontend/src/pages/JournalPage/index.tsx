...
export function JournalPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full bg-lavender min-h-screen py-12 px-6 max-[473px]:px-0 pt-32">
      <div className="w-full max-w-3xl bg-pearl rounded-3xl max-[473px]:rounded-none border-[3px] max-[473px]:border-none border-darkblue shadow-lg p-6 md:p-12">
        ...
        <div className="flex justify-center items-center gap-4 mt-6">
          <button
            className="bg-midblue hover:bg-darkblue text-pearl font-semibold font-Sora px-8 py-4 rounded-full  max-[473px]:px-6 max-[473px]:py-2 border-2 text-lg border-darkblue transition-all duration-300 shadow-md"
          >
            Save Entry
          </button>
          <button
            className="bg-pearl hover:bg-lightlavender text-darkblue font-semibold font-Sora px-8 py-4 rounded-full  max-[473px]:px-6 max-[473px]:py-2 text-lg border-2 border-darkblue transition-all duration-300 shadow-md"
          >
            Analyze Entry
          </button>
        </div>
