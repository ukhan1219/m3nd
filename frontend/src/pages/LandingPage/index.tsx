  ...
  return (
      <div className="flex flex-col items-center w-full bg-lavender pt-20">
          ...
          <div className="w-full bg-pearl font-Kanit py-16 px-6 ">
              ...
              <div className="bg-midblue max-sm:w-full sm:w-7/12 lg:w-6/12 rounded-3xl max-w-3xl font-Kanit text-left mx-auto font-light border-4 border-darkblue 2xl:text-xl text-lg">
